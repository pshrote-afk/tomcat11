...
EmployeeDTO employeeDTO = employeeDAO.deleteByEmployeeId(employeeId);
...
pw.println("<br>");
pw.println("<form action='/styleone/employeesView' onsubmit='return validateForm(this)'>");
pw.println("Employee "+employeeDTO.getName()+" successfully deleted.<br><br>");
