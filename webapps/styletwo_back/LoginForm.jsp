...
Username: <input type='text' id='username' name='username' placeholder='Username' size='15'><br><br>
Password: <input type='password' id='password' name='password' placeholder='Password' size='15' required><br><br>
