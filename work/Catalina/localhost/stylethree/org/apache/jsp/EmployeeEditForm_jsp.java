 ...
 * Generated at: 2025-09-10 03:01:07 UTC
...
public final class EmployeeEditForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("cancelEmployeeUpdation();\r\n");
      out.write("}\r\n");
      ...
      out.write("{\r\n");
      out.write("success = JSON.parse(this.responseText).success;\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function updateEmployee()\r\n");
      out.write("{\r\n");
      out.write("var employeeEditForm = document.getElementById('employeeEditForm');\r\n");
      out.write("if(validateForm(employeeEditForm)==false)\r\n");
      out.write("{\r\n");
      out.write("return;\r\n");
      out.write("}\r\n");
      ...
      out.write("var gender = document.getElementById('employeeEditForm').gender.value;	//note: we got form's id and then .gender.value returns the value of selected radio button\r\n");
      ...
      out.write("if(panNumberExistence==true) panNumberErrorSection.innerText = \"PAN number already exists\";\r\n");
      ...
      out.write("}\r\n");
      out.write("//control reaches here means all 4 fields are valid. Proceed to actually edit.\r\n");
      out.write("\r\n");
      out.write("var xmlHttpRequest = new XMLHttpRequest();\r\n");
      out.write("xmlHttpRequest.onreadystatechange = function() {\r\n");
      out.write("if(this.readyState==4)\r\n");
      ...
      out.write("{\r\n");
      out.write("var employeeEditForm = document.getElementById('employeeEditForm');\r\n");
      out.write("employeeEditFormTable.style.display='none';	\r\n");
      ...
      out.write("message.innerText = 'Employee updated successfully.'\r\n");
      out.write("editButton.innerText = 'OK';\r\n");
      out.write("editButton.onclick = goToEmployeesView;\r\n");
      ...
      out.write("}\r\n");
      out.write("};\r\n");
      out.write("xmlHttpRequest.open(\"POST\",\"employees/update\",true);\r\n");
      ...
      out.write("document.getElementById('name').value = responseData.data.name;\r\n");
      out.write("document.getElementById('designationCode').value = responseData.data.designationCode;\r\n");
      out.write("document.getElementById('dateOfBirth').value = responseData.data.dateOfBirth;\r\n");
      out.write("document.getElementById('employeeEditForm').gender.value = (responseData.data.gender == 'M')?'M':'F';\r\n");
      out.write("document.getElementById('isIndian').checked = (responseData.data.isIndian==true);		//returns true/false\r\n");
      out.write("document.getElementById('basicSalary').value = responseData.data.basicSalary;\r\n");
      out.write("document.getElementById('panNumber').value = responseData.data.panNumber;\r\n");
      out.write("document.getElementById('aadharCardNumber').value = responseData.data.aadharCardNumber;\r\n");
      out.write("}\r\n");
      ...
      out.write("window.addEventListener('load',editEmployee);\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "/MasterPageTopSection.jsp", out, false);
      out.write("\r\n");
      out.write("<script src='/stylethree/js/EmployeeEditForm.js'></script>\r\n");
      out.write("<h2>Employee (Edit Module)</h2><br>\r\n");
      out.write("<form id='employeeEditForm'>\r\n");
      ...
      out.write("<table id='employeeEditFormTable'>\r\n");
      out.write("<tr>\r\n");
      ...
      out.write("</td>\r\n");
      out.write("<td>\r\n");
      out.write("<button type='button' id='editButton' onclick='updateEmployee()'>Update</button>\r\n");
      out.write("</form>\r\n");
      out.write("</td>\r\n");
      out.write("<td>\r\n");
      out.write("<button type='button' id='cancelButton' onclick='cancelEmployeeUpdation()'>Cancel</button>\r\n");
      out.write("</td>\r\n");
      out.write("</tr>\r\n");
      out.write("</table>\r\n");
      out.write("<form action='/stylethree/Employees.jsp' id='cancelEmployeeUpdationForm'>\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
